...
export const api = {
  ...
  getPolicies: async (): Promise<Policy[]> => {
    await delay(200);
    return [
      { id: 'p-001', name: 'SOC2 Type II Controls', source: 'upload', framework: 'SOC2', controlsExtracted: 64, status: 'active', ingestedAt: '2026-05-08T09:00:00Z' },
      { id: 'p-002', name: 'GDPR Data Processing', source: 'upload', framework: 'GDPR', controlsExtracted: 42, status: 'active', ingestedAt: '2026-05-07T14:30:00Z' },
      { id: 'p-003', name: 'BSP Circular 1140', source: 'scraper', framework: 'BSP', controlsExtracted: 31, status: 'active', ingestedAt: '2026-05-09T03:00:00Z' },
      { id: 'p-004', name: 'ISO 27001 Annex A', source: 'upload', framework: 'ISO27001', controlsExtracted: 93, status: 'active', ingestedAt: '2026-05-06T11:00:00Z' },
      { id: 'p-005', name: 'NPC Circular 2023-06', source: 'scraper', framework: 'NPC', controlsExtracted: 0, status: 'processing', ingestedAt: '2026-05-09T14:00:00Z' },
    ];
  },
  ...
  getPipelineEvents: async (): Promise<PipelineEvent[]> => {
    await delay(150);
    return [
      { id: 'pe-001', timestamp: '2026-05-09T14:35:12Z', stage: 'PolicyGate Scan', status: 'running', message: 'Scanning payments-api push (3 files changed)' },
      { id: 'pe-002', timestamp: '2026-05-09T14:34:50Z', stage: 'Gitleaks', status: 'success', message: 'Secret scan complete — 1 finding' },
      { id: 'pe-003', timestamp: '2026-05-09T14:34:45Z', stage: 'Presidio', status: 'success', message: 'PII scan complete — 0 findings' },
      { id: 'pe-004', timestamp: '2026-05-09T14:34:30Z', stage: 'HITL Interrupt', status: 'waiting', message: 'Awaiting manager approval for hitl-001' },
      { id: 'pe-005', timestamp: '2026-05-09T14:00:00Z', stage: 'RegIntel Ingest', status: 'running', message: 'Processing NPC Circular 2023-06 (RAG chunking)' },
      { id: 'pe-006', timestamp: '2026-05-09T13:55:00Z', stage: 'LLM Normalization', status: 'success', message: 'Extracted 31 controls from BSP Circular 1140' },
    ];
  },
  ...
  getSystemHealth: async (): Promise<SystemHealth[]> => {
    await delay(100);
    return [
      { service: 'FastAPI Backend', status: 'healthy', latency: '12ms', uptime: '99.9%' },
      { service: 'PostgreSQL', status: 'healthy', latency: '3ms', uptime: '99.99%' },
      { service: 'vLLM (Llama-3.1-70B)', status: 'healthy', latency: '890ms', uptime: '98.5%' },
      { service: 'Loki Logging', status: 'healthy', latency: '8ms', uptime: '99.95%' },
      { service: 'Grafana', status: 'healthy', latency: '15ms', uptime: '99.9%' },
      { service: 'Regulatory Scraper', status: 'degraded', latency: '2.1s', uptime: '95.2%' },
    ];
  },
  ...
  ingestPolicy: async (file: File): Promise<LegacyIngestResponse> => {
    ...
    return {
      ...
      controlsExtracted: 5,
      controls: [
        { id: 'ctrl-1', title: 'Access Control', description: 'Enforce role-based access control (RBAC) for all production systems', framework: 'SOC2', severity: 'critical' },
        { id: 'ctrl-2', title: 'Data Encryption', description: 'All data at rest must use AES-256 encryption', framework: 'SOC2', severity: 'high' },
        { id: 'ctrl-3', title: 'Audit Logging', description: 'Maintain immutable audit logs for all privileged actions', framework: 'SOC2', severity: 'high' },
        { id: 'ctrl-4', title: 'Incident Response', description: 'Incident response plan must be tested quarterly', framework: 'SOC2', severity: 'medium' },
        { id: 'ctrl-5', title: 'Vendor Assessment', description: 'Third-party vendors must complete security questionnaire annually', framework: 'SOC2', severity: 'medium' },
      ],
      status: 'active',
